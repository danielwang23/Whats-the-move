// src/components/Question2Page.js
import React, { useState } from 'react';
import '../styles/QuestionPage2CSS.css';
...
function Question2Page({ preferences, setPreferences, onNext }) {
  const [selectedOptions, setSelectedOptions] = useState(
    preferences.Activity ? preferences.Activity.split(', ') : []
  );
